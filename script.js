    ...
    Transaction_arr.forEach((item,index) => {
        ...
        <div class="transaction-row" data-transaction-id=${index}>
            <div class="transaction-cell transaction-icon-cell">
                <span class="transaction-icon ${type}-category-icon ${type}-icon" aria-hidden="true">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"></rect><line x1="2" y1="10" x2="22" y2="10"></line><line x1="6" y1="15" x2="10" y2="15"></line></svg>
                </span>
            </div>
            ...
            <div class="transaction-cell transaction-amount-cell">
                <span class="transaction-amount ${type}-amount-text">+₹${amount}</span>
                <span class="transaction-type-badge type-${type}">${type || 'income'}</span>
            </div>
            <div class="transaction-cell transaction-actions">
                <button class="action-btn edit-btn" aria-label="Edit transaction" data-edit-id=${index}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                </button>
                <button class="action-btn delete-btn" aria-label="Delete transaction" data-delete-id=${index}>
